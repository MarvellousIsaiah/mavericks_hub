...
import static com.maverickstube.maverickshub.Security.config.utils.SecurityUtils.JWT_PREFIX;
import static com.maverickstube.maverickshub.Security.config.utils.SecurityUtils.PUBLIC_ENDPOINTS;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //1b. if request path from 1a is a public path, call the next filter in chain and terminate this filter execution.
